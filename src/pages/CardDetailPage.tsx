...
const dummyCardData: Record<string, Card> = {
  card1: {
    ...
    att2Desc: 'Take out the water gun you bought at the toy store and spray it at the other person. (40)',
  ...
  card2: {
    ...
    flavor: 'This Pokemon was considered a legendary Pokemon until a small colony was discovered under water.',
  },
};
...
const CardDetailPage: React.FC = () => {
  ...
  <img
    src={card.image}
    alt={card.name}
    className="block max-h-[600px] object-contain rounded-3xl shadow mb-4"
  />
</div>
        ...
        <div className="md:w-2/3">
          ...
          <table className="w-full border-collapse">
            ...
            <tr>
                <th className="py-2 pr-4 text-left font-semibold">Measurements</th>
                <td className="py-2">{card.metadata}</td>
              </tr>
              <tr>
                <th className="py-2 pr-4 text-left font-semibold">{card.att1}</th>
                <td className="py-2">
                  <img
                    src={card.att1Icon}
                    alt="Attack 1 Icon"
                    className="inline-block w-5 h-5 mr-2 align-middle mb-1 rounded-full"
                  />{card.att1Desc}</td>
              </tr>
              <tr>
                <th className="py-2 pr-4 text-left font-semibold">{card.att2}</th>
                <td className="py-2">
                  <img
                    src={card.att2Icon}
                    alt="Attack 1 Icon"
              ...
              <tr>
                <th className="py-2 pr-4 text-left font-semibold">Flavor Text</th>
                <td className="py-2">{card.flavor}</td>
              </tr>

              <tr>
                <th className="py-2 pr-4 text-left font-semibold">Illustrator</th>
              ...
              <tr>
                <th className="py-2 pr-4 text-left font-semibold"><img
                      src={card.setLogo}
                      alt={card.setName}
