...
const dummyCardData: Record<string, Card> = {
  card1: {
    ...
    hp: "25",
    setName: "17/50",
    setLogo: "/src/assets/wmSet1.jpg",
    att1: "Bite",
    att1Icon: "/src/assets/iconNormal.jpg",
    att1Desc: "Biting someone (30)",
    att2: "Water Gun",
    att2Icon: "/src/assets/iconWater.jpg",
    att2Desc:
  ...
  card2: {
    ...
    setLogo: "/src/assets/wmSet1.jpg",
    att1: "Dragin Tail",
    att1Icon: "/src/assets/iconDragon.jpg",
    att1Desc: "Attacks opponent with its tail. (40)",
    att2: "Staring",
    att2Icon: "/src/assets/iconNormal.jpg",
